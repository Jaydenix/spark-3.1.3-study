...
private[spark] class WorkerInfo(
  ...
  override def toString: String = s"WorkerInfo(id=$id, host=$host, cores=$cores, memory=$memory, resources=$resources," +
    s"coresFree=$coresFree, memoryFree=$memoryFree,state=$state," +
    s"executors=$executors,coresUsed=$coresUsed, memoryUsed=$memoryUsed," +
    s"resourcesInfo=$resourcesInfo,resourcesAmountFree=$resourcesAmountFree," +
    s"resourcesInfoFree=$resourcesInfoFree, resourcesInfoUsed=$resourcesInfoUsed)"
}
