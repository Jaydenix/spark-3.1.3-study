...
private[cluster] class ExecutorData(
  ...
  override def toString: String = s"ExecutorData(executorHost=$executorHost,executorAddress=$executorAddress," +
    s" freeCores=$freeCores, totalCores=$totalCores," +
    s" attributes=$attributes, resourcesInfo=$resourcesInfo, resourceProfileId=$resourceProfileId," +
    s" registrationTs=$registrationTs)"
}
